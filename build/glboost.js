...
// This revision is the commit right after the SHA: ed5ab89f
...
//    this._finalMatrix = Matrix44.identity();
  ...
  getMatrixNotAnimated() {
    ...
    this._matrix = Matrix44$1$1.multiply(rotationMatrix, Matrix44$1$1.scale(scale));
...
class SPVGLTFLoader {
  ...
  static getInstance() {
    if (!this[singleton$8]) {
      this[singleton$8] = new SPVGLTFLoader(singletonEnforcer$6);
    }
...
class SPVGLTFLoaderExtension {
   ...
   */
  constructor(enforcer) {
    if (enforcer !== singletonEnforcer$7) {
      throw new Error("This is a Singleton class. get the instance using 'getInstance' static method.");
    }
  }
  ...
  static getInstance() {
    if (!this[singleton$9]) {
      this[singleton$9] = new SPVGLTFLoaderExtension(singletonEnforcer$7);
    }
...
GLBoost$1["SPVGLTFLoaderExtension"] = SPVGLTFLoaderExtension;
...
let singleton$10 = Symbol();
let singletonEnforcer$8 = Symbol();
...
class VRizeGLTFLoaderExtension {
   ...
   */
  constructor(enforcer) {
    if (enforcer !== singletonEnforcer$8) {
      throw new Error("This is a Singleton class. get the instance using 'getInstance' static method.");
    }
  }
   ...
   */
  static getInstance() {
    if (!this[singleton$10]) {
      this[singleton$10] = new VRizeGLTFLoaderExtension(singletonEnforcer$8);
    }
    return this[singleton$10];
  }
