(function (global, factory) {
  ...
  var L_GLBoostMonitor = function () {
    ...
    babelHelpers.createClass(L_GLBoostMonitor, [{
      ...
      value: function getInstance() {
        if (!this[singleton$4]) {
          this[singleton$4] = new L_GLBoostMonitor(L_GLBoostMonitor._singletonEnforcer);
        }
  ...
  var SPVDecalShaderSource = function () {
    ...
    babelHelpers.createClass(SPVDecalShaderSource, [{
      ...
      value: function prepare_SPVDecalShaderSource(gl, shaderProgram, expression, vertexAttribs, existCamera_f, lights, material, extraData) {
        ...
        var vertexAttribsAsResult = [];
        vertexAttribs.forEach(function (attribName) {
          if (attribName === GLBoost$1.COLOR || attribName === GLBoost$1.TEXCOORD) {
            shaderProgram['vertexAttribute_' + attribName] = gl.getAttribLocation(shaderProgram, 'aVertex_' + attribName);
            gl.enableVertexAttribArray(shaderProgram['vertexAttribute_' + attribName]);
            vertexAttribsAsResult.push(attribName);
          }
  ...
  var SPVDecalShader = function (_WireframeShader) {
    ...
    babelHelpers.createClass(SPVDecalShader, [{
      ...
      value: function setUniforms(gl, glslProgram, expression, material, camera, mesh, lights) {
        ...
        var texture = material.getTextureFromPurpose(GLBoost$1.TEXTURE_PURPOSE_DIFFUSE);
  ...
  GLBoost$1['SPVDecalShader'] = SPVDecalShader;
  ...
  var L_AbstractMaterial = function (_GLBoostObject) {
    ...
    babelHelpers.createClass(L_AbstractMaterial, [{
      ...
      value: function setTexture(texture, purpose) {
        ...
        this._texturePurposeDic[typeof purpose !== 'undefined' ? purpose : GLBoost$1.TEXTURE_PURPOSE_DIFFUSE] = texture.userFlavorName;
  ...
  var SPVClassicMaterial = function (_L_AbstractMaterial) {
    babelHelpers.inherits(SPVClassicMaterial, _L_AbstractMaterial);
    ...
    function SPVClassicMaterial(glBoostContext) {
      ...
      _this._isWireframeOnShade = false;
      return _this;
    }
  ...
  var DrawKickerLocal = function () {
    ...
    babelHelpers.createClass(DrawKickerLocal, [{
      ...
      value: function getInstance() {
        if (!this[singleton$5]) {
          this[singleton$5] = new DrawKickerLocal(singletonEnforcer$3);
        }
    ...
    babelHelpers.createClass(DrawKickerWorld, [{
      ...
      value: function draw(gl, glem, expression, mesh, materials, camera, lights, scene, vertices, vaoDic, vboDic, iboArrayDic, geometry, geometryName, primitiveType, vertexN, renderPassIndex) {
        ...
        for (var i = 0; i < materials.length; i++) {
          ...
          if (geometry.isIndexed()) {
            gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, iboArrayDic[geometryName][i]);
            var _vertexN = material.getVertexN(geometry);
            var indexBitSize = glem.elementIndexBitSize(gl);
            gl.drawElements(gl[primitiveType], _vertexN, indexBitSize, 0);
            gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, null);
          } else {
            gl.drawArrays(gl[primitiveType], 0, vertexN);
          }
      ...
      value: function getInstance() {
        if (!this[singleton$6]) {
          this[singleton$6] = new DrawKickerWorld(singletonEnforcer$4);
        }
  ...
  var SPVScreen = function (_Geometry) {
    babelHelpers.inherits(SPVScreen, _Geometry);

    function SPVScreen(glBoostContext) {
      ...
      babelHelpers.classCallCheck(this, SPVScreen);

      var _this = babelHelpers.possibleConstructorReturn(this, (SPVScreen.__proto__ || Object.getPrototypeOf(SPVScreen)).call(this, glBoostContext));

      _this._setupVertexData(layout, customVertexAttributes);
      return _this;
    }
      ...
      value: function _setupQuad(positions, indices, colors, texcoords, normals, originInRatioVec2, sizeInRatioVec2, uSpan, vSpan, uUVRepeat, vUVRepeat) {
        ...
        for (var _i3 = 0; _i3 <= vSpan; _i3++) {
          for (var _j3 = 0; _j3 <= uSpan; _j3++) {
            var uSpanToDivide = uUVRepeat ? 1 : uSpan;
            var vSpanToDivide = vUVRepeat ? 1 : vSpan;
            texcoords.push(new Vector2(_j3 / uSpanToDivide, _i3 / vSpanToDivide));
          }
        }

        var normal = new Vector3(0, 0, -1); // specify -1 because This Screen geometry assumes that It doesn't use a projection matrix.
  ...
  var M_SPVScreenMesh = function (_M_Mesh) {
    ...
    babelHelpers.createClass(M_SPVScreenMesh, [{
      ...
      value: function _init(layout, customVertexAttributes) {
        ...
        var material = new SPVClassicMaterial(this._glBoostContext);
  ...
  var ClassicMaterial$1 = function (_L_AbstractMaterial) {
    ...
    function ClassicMaterial(glBoostContext) {
      ...
      return babelHelpers.possibleConstructorReturn(this, (ClassicMaterial.__proto__ || Object.getPrototypeOf(ClassicMaterial)).call(this, glBoostContext));
    }
  ...
  var M_Group = function (_M_Element) {
    ...
    babelHelpers.createClass(M_Group, [{
      ...
      value: function searchElement(query) {
        var queryMeta = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { type: GLBoost.QUERY_TYPE_USER_FLAVOR_NAME, format: GLBoost.QUERY_FORMAT_STRING };
      ...
      value: function searchGLBoostObjectsByNameAndType(query, type) {
        ...
        if (type === L_AbstractMaterial && element instanceof M_Mesh) {
          ...
          try {
            for (var _iterator2 = materials[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  var GLBoostLowContext = function () {
    ...
    babelHelpers.createClass(GLBoostLowContext, [{
      ...
      key: 'createSPVScreen',
      value: function createSPVScreen(layout, customVertexAttributes) {
  ...
  var GLBoostMiddleContext = function (_GLBoostLowContext) {
    ...
    function GLBoostMiddleContext(canvas, gl, width, height) {
      ...
      var _this = babelHelpers.possibleConstructorReturn(this, (GLBoostMiddleContext.__proto__ || Object.getPrototypeOf(GLBoostMiddleContext)).call(this, canvas, gl, width, height));
  ...
  var PhongShader = function (_DecalShader) {
    ...
    babelHelpers.createClass(PhongShader, [{
      key: 'setUniforms',
      value: function setUniforms(gl, glslProgram, expression, material, camera, mesh, lights) {
        babelHelpers.get(PhongShader.prototype.__proto__ || Object.getPrototypeOf(PhongShader.prototype), 'setUniforms', this).call(this, gl, glslProgram, expression, material, camera, mesh, lights);
  ...
  var LambertShader = function (_DecalShader) {
    ...
    babelHelpers.createClass(LambertShader, [{
      key: 'setUniforms',
      value: function setUniforms(gl, glslProgram, expression, material, camera, mesh, lights) {
        babelHelpers.get(LambertShader.prototype.__proto__ || Object.getPrototypeOf(LambertShader.prototype), 'setUniforms', this).call(this, gl, glslProgram, expression, material, camera, mesh, lights);
  ...
  var SPVLambertShader = function (_SPVDecalShader) {
    ...
    babelHelpers.createClass(SPVLambertShader, [{
      key: 'setUniforms',
      value: function setUniforms(gl, glslProgram, expression, material, camera, mesh, lights) {
        babelHelpers.get(SPVLambertShader.prototype.__proto__ || Object.getPrototypeOf(SPVLambertShader.prototype), 'setUniforms', this).call(this, gl, glslProgram, expression, material, camera, mesh, lights);
      ...
      key: 'setUniformsAsTearDown',
      value: function setUniformsAsTearDown(gl, glslProgram, expression, material, camera, mesh, lights) {
        babelHelpers.get(SPVLambertShader.prototype.__proto__ || Object.getPrototypeOf(SPVLambertShader.prototype), 'setUniformsAsTearDown', this).call(this, gl, glslProgram, expression, material);
        for (var i = 0; i < lights.length; i++) {
          if (lights[i].camera && lights[i].camera.texture) {
            // set depthTexture unit i+1 to the sampler
            gl.uniform1i(material.getUniform(glslProgram.hashId, 'uniform_DepthTextureSampler_' + i), 0); // +1 because 0 is used for diffuse texture
  ...
  var SPVPhongShaderSource = function () {
    ...
    babelHelpers.createClass(SPVPhongShaderSource, [{
      key: 'FSDefine_SPVPhongShaderSource',
      value: function FSDefine_SPVPhongShaderSource(in_, f, lights) {
        var shaderText = '';
        shaderText += 'uniform vec3 viewPosition;\n';
        shaderText += 'uniform vec4 Kd;\n';
        shaderText += 'uniform vec4 Ks;\n';
      ...
      key: 'FSShade_SPVPhongShaderSource',
      value: function FSShade_SPVPhongShaderSource(f, gl, lights) {
    ...
    return SPVPhongShaderSource;
  }();

  var SPVPhongShader = function (_SPVDecalShader) {
    babelHelpers.inherits(SPVPhongShader, _SPVDecalShader);

    function SPVPhongShader(glBoostContext, basicShader) {
      babelHelpers.classCallCheck(this, SPVPhongShader);

      var _this = babelHelpers.possibleConstructorReturn(this, (SPVPhongShader.__proto__ || Object.getPrototypeOf(SPVPhongShader)).call(this, glBoostContext, basicShader));
    ...
    babelHelpers.createClass(SPVPhongShader, [{
      key: 'setUniforms',
      value: function setUniforms(gl, glslProgram, expression, material, camera, mesh, lights) {
        babelHelpers.get(SPVPhongShader.prototype.__proto__ || Object.getPrototypeOf(SPVPhongShader.prototype), 'setUniforms', this).call(this, gl, glslProgram, expression, material, camera, mesh, lights);
      ...
      key: 'setUniformsAsTearDown',
      value: function setUniformsAsTearDown(gl, glslProgram, expression, material, camera, mesh, lights) {
        babelHelpers.get(SPVPhongShader.prototype.__proto__ || Object.getPrototypeOf(SPVPhongShader.prototype), 'setUniformsAsTearDown', this).call(this, gl, glslProgram, expression, material);
        for (var i = 0; i < lights.length; i++) {
          if (lights[i].camera && lights[i].camera.texture) {
            // set depthTexture unit i+1 to the sampler
            gl.uniform1i(material.getUniform(glslProgram.hashId, 'uniform_DepthTextureSampler_' + i), 0); // +1 because 0 is used for diffuse texture
  ...
  var SPVGLTFLoader = function () {

    /**
     * [en] The constructor of SPVGLTFLoader class. But you cannot use this constructor directly because of this class is a singleton class. Use getInstance() static method.<br>
     * [ja] SPVGLTFLoaderクラスのコンストラクタです。しかし本クラスはシングルトンであるため、このコンストラクタは直接呼び出せません。getInstance()静的メソッドを使ってください。
     * @param {Symbol} enforcer [en] a Symbol to forbid calling this constructor directly [ja] このコンストラクタの直接呼び出しを禁止するためのシンボル
     */
    function SPVGLTFLoader(enforcer) {
      babelHelpers.classCallCheck(this, SPVGLTFLoader);
    ...
    babelHelpers.createClass(SPVGLTFLoader, [{
      key: 'loadGLTF',
        ...
        if (defaultShader) {
          ...
          switch (techniqueStr) {
            ...
            case 'LAMBERT':
              ...
              break;
            case 'PHONG':
              material.shaderClass = SPVPhongShader;
              break;
          }
        } else {
          if (typeof json.techniques !== 'undefined') {
      ...
      value: function _accessBinary(accessorStr, json, buffers) {
        ...
        if (toGetAsTypedArray) {
          if (SPVGLTFLoader._isSystemLittleEndian()) {
            if (dataViewMethod === 'getFloat32') {
              vertexAttributeArray = this._adjustByteAlign(Float32Array, arrayBuffer, 4, byteOffset, byteLength / bytesPerComponent);
            } else if (dataViewMethod === 'getInt8') {
              vertexAttributeArray = new Int8Array(arrayBuffer, byteOffset, byteLength / bytesPerComponent);
      ...
      value: function getInstance() {
        if (!this[singleton$2]) {
          this[singleton$2] = new SPVGLTFLoader(singletonEnforcer$2);
        }
    ...
    return SPVGLTFLoader;
  }();

  GLBoost$1["SPVGLTFLoader"] = SPVGLTFLoader;
  ...
  var H_SPVScreenLUT = function (_M_SPVScreenMesh) {
    ...
    babelHelpers.createClass(H_SPVScreenLUT, [{
      key: 'inputTexture',
      set: function set(inputTexture) {
